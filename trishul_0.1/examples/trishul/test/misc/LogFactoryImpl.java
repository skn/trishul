...
public class LogFactoryImpl {
	...
	{
		LogConfigurationException (String msg)
		{
			super (msg);
		}
		
		LogConfigurationException (Throwable t)
		{
			super (t);
		}

		LogConfigurationException (String msg, Throwable t)
		{
			super (msg, t);
		}
        ...
        throws ClassNotFoundException
    {
        Object result = AccessController.doPrivileged(
            new PrivilegedAction() {
                public Object run() {
                    ClassLoader threadCL = ClassLoader.getSystemClassLoader();
                    if (threadCL != null) {
                        try {
