...
typedef struct Hjava_lang_Object {
    ...
    void*       finalizer_call;
	 ...
	 // PS
	taint_t obj_taint;
	taint_t	*member_taint; // Also taint of elements in case of array
...
extern int	utf8ConstSubStringEqualJavaString(const Utf8Const*, unsigned int, unsigned int, const HString*);
