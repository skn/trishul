...
extern void		do_execute_java_method(jvalue *retval, void*, taint_t, const char*, const char*, struct _jmethodID*, int, ...);
extern void		do_execute_java_method_v(jvalue *retval, void*, taint_t, const char*, const char*, struct _jmethodID*, int, va_list);
...
extern void	KaffeVM_callMethodA(struct _jmethodID*, void*, void*, taint_t, jvalue*, jvalue*, int);
extern void	KaffeVM_callMethodV(struct _jmethodID*, void*, void*, taint_t, va_list, jvalue*);
extern void     KaffeVM_safeCallMethodA(struct _jmethodID*, void*, void*, taint_t, jvalue*, jvalue*, int);
extern void     KaffeVM_safeCallMethodV(struct _jmethodID*, void*, void*, taint_t, va_list, jvalue*);
