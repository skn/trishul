...
extern Hjava_lang_String* utf8ConstSubString2Java(const Utf8Const*, unsigned int start, unsigned int length); // PS
...
extern Hjava_lang_String* utf8Const2JavaReplace(const Utf8Const *,
				jchar, jchar);
extern Hjava_lang_String* utf8ConstSubString2JavaReplace(const Utf8Const *,
				unsigned int, unsigned int, jchar, jchar); // PS
