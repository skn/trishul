...
defaultObjectFinalizer(jobject ob)
{
  ...
  KaffeVM_safeCallMethodA(final, METHOD_NATIVECODE(final), obj, 0, NULL, NULL, 0);
...
referenceObjectFinalizer(jobject ob)
{
  ...
  while (ll != NULL)
	...
	{
	  KaffeVM_safeCallMethodA(mid, METHOD_NATIVECODE(mid), ll->reference, 0, NULL, NULL, false);
