...
jobject  KaffeJNI_CallNonvirtualObjectMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
jobject  KaffeJNI_CallNonvirtualObjectMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
jobject  KaffeJNI_CallNonvirtualObjectMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);

jboolean KaffeJNI_CallNonvirtualBooleanMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
jboolean KaffeJNI_CallNonvirtualBooleanMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
jboolean KaffeJNI_CallNonvirtualBooleanMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);

jbyte    KaffeJNI_CallNonvirtualByteMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
jbyte    KaffeJNI_CallNonvirtualByteMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
jbyte    KaffeJNI_CallNonvirtualByteMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);

jchar    KaffeJNI_CallNonvirtualCharMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
jchar    KaffeJNI_CallNonvirtualCharMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
jchar    KaffeJNI_CallNonvirtualCharMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);

jshort   KaffeJNI_CallNonvirtualShortMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
jshort   KaffeJNI_CallNonvirtualShortMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
jshort   KaffeJNI_CallNonvirtualShortMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);

jint     KaffeJNI_CallNonvirtualIntMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
jint     KaffeJNI_CallNonvirtualIntMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
jint     KaffeJNI_CallNonvirtualIntMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);

void     KaffeJNI_CallVoidMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
void     KaffeJNI_CallVoidMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
void     KaffeJNI_CallVoidMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jobject  KaffeJNI_CallObjectMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
jobject  KaffeJNI_CallObjectMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
jobject  KaffeJNI_CallObjectMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jboolean KaffeJNI_CallBooleanMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
jboolean KaffeJNI_CallBooleanMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
jboolean KaffeJNI_CallBooleanMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jbyte    KaffeJNI_CallByteMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
jbyte    KaffeJNI_CallByteMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
jbyte    KaffeJNI_CallByteMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jchar    KaffeJNI_CallCharMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
jchar    KaffeJNI_CallCharMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
jchar    KaffeJNI_CallCharMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jshort   KaffeJNI_CallShortMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
jshort   KaffeJNI_CallShortMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
jshort   KaffeJNI_CallShortMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jint     KaffeJNI_CallIntMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
jint     KaffeJNI_CallIntMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
jint     KaffeJNI_CallIntMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jlong    KaffeJNI_CallLongMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
jlong    KaffeJNI_CallLongMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
jlong    KaffeJNI_CallLongMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jfloat   KaffeJNI_CallFloatMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
jfloat   KaffeJNI_CallFloatMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
jfloat   KaffeJNI_CallFloatMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jdouble  KaffeJNI_CallDoubleMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, va_list args);
jdouble  KaffeJNI_CallDoubleMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, ...);
jdouble  KaffeJNI_CallDoubleMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jmethodID meth, jvalue* args);

jlong    KaffeJNI_CallNonvirtualLongMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
jlong    KaffeJNI_CallNonvirtualLongMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
jlong    KaffeJNI_CallNonvirtualLongMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);

jfloat   KaffeJNI_CallNonvirtualFloatMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
jfloat   KaffeJNI_CallNonvirtualFloatMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
jfloat   KaffeJNI_CallNonvirtualFloatMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);

jdouble  KaffeJNI_CallNonvirtualDoubleMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
jdouble  KaffeJNI_CallNonvirtualDoubleMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
jdouble  KaffeJNI_CallNonvirtualDoubleMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);

void     KaffeJNI_CallNonvirtualVoidMethodTaintV(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, va_list args);
void     KaffeJNI_CallNonvirtualVoidMethodTaint(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, ...);
void     KaffeJNI_CallNonvirtualVoidMethodTaintA(JNIEnv* env, jobject obj, taint_t objTaint, jclass cls, jmethodID meth, jvalue* args);
