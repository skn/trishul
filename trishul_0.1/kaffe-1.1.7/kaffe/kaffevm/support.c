 ...
 */
void
do_execute_java_method_v(jvalue *retval, void* obj, taint_t objTaint, const char* method_name, const char* signature, Method* mb, int isStaticCall, va_list argptr)
{
	errorInfo info;
	...
	KaffeVM_callMethodV(mb, METHOD_NATIVECODE(mb), obj, objTaint, argptr, retval);
}
 ...
 */
void
do_execute_java_method(jvalue *retval, void* obj, taint_t objTaint, const char* method_name, const char* signature, Method* mb, int isStaticCall, ...)
{
	va_list argptr;
	...
	do_execute_java_method_v(retval, obj, objTaint, method_name, signature, mb, isStaticCall, argptr);
	va_end(argptr);
}
	...
	const char* signature, va_list argptr)
{
	...
	/* Make the call */
	KaffeVM_callMethodV(mb, METHOD_NATIVECODE(mb), NULL, 0, argptr, retval);
}
	...
	Hjava_lang_Class* cc, const char* signature, va_list argptr)
{
	...
	/* Make the call */
	KaffeVM_callMethodV(mb, METHOD_NATIVECODE(mb), obj, 0, argptr, &retval);
 ...
 */
void
KaffeVM_safeCallMethodA(Method* meth, void* func, void* obj, taint_t objTaint, jvalue* args, jvalue* ret,
			int promoted)
{
  BEGIN_EXCEPTION_HANDLING_VOID();

  KaffeVM_callMethodA(meth, func, obj, objTaint, args, ret, promoted);
 ...
 */
void
KaffeVM_safeCallMethodV(Method* meth, void* func, void* obj, taint_t objTaint, va_list args, jvalue* ret)
{
  BEGIN_EXCEPTION_HANDLING_VOID();

  KaffeVM_callMethodV(meth, func, obj, objTaint, args, ret);
