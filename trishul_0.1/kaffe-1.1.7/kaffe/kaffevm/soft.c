...
// In the interpreter, taint propagation is handled before the call. As the soft methods are not called through JNI
// the native taint info is not available.
#ifndef INTERPRETER
	nativeRetValSetTaint ('A', 0);
#endif
...
DBG(NEWINSTR,
	dprintf("New array of %s [%d] (%p) (%p %p)\n",
		TYPE_CLASS(type)->name->data, size, obj, &obj->member_taint, obj->member_taint); );

#ifndef INTERPRETER
	nativeRetValSetTaint ('A', 0);
	obj->obj_taint = nativeParamGetTaint (1);
#endif
	return (obj);
}
...
#ifndef INTERPRETER
				taintAdd1 (taint, 1 + nativeParamGetTaint (i));
#endif
                arraydims[i] = arg;
        }
        arraydims[i] = -1;
 ...
 */
void
soft_athrow(Hjava_lang_Object* o, taint_t t) /* PS */
{
	if (o == NULL) {
		soft_nullpointer();
	}
	else {
		taintAdd1 (t, nativeContextGetTaint ());
		 ...
		 */
		throwExternalException((Hjava_lang_Throwable*)o, t);
	}
}
...
{
#ifndef INTERPRETER
	nativeRetValSetTaint ('I', taintMerge2 (nativeParamGetTaint (0), nativeParamGetTaint (2)));
#endif
	jint ret;
...
{
#ifndef INTERPRETER
	nativeRetValSetTaint ('I', taintMerge2 (nativeParamGetTaint (0), nativeParamGetTaint (1)));
#endif
        jint ret;
	jint v1bits;
	jint v2bits;
...
{
#ifndef INTERPRETER
	nativeRetValSetTaint ('J', taintMerge2 (nativeParamGetTaint (0), nativeParamGetTaint (2)));
#endif
	return (v1 * v2);
}
...
{
#ifndef INTERPRETER
	nativeRetValSetTaint ('F', taintMerge2 (nativeParamGetTaint (0), nativeParamGetTaint (1)));
#endif
...
{
#ifndef INTERPRETER
	nativeRetValSetTaint ('D', taintMerge2 (nativeParamGetTaint (0), nativeParamGetTaint (2)));
#endif
...
{
#ifndef INTERPRETER
	nativeRetValSetTaint ('F', nativeParamGetTaint (0));
#endif
	return ((jfloat)v);
}
...
{
#ifndef INTERPRETER
	nativeRetValSetTaint ('D', nativeParamGetTaint (0));
#endif
	return ((jdouble)v);
}
...
{
#ifndef INTERPRETER
	nativeRetValSetTaint ('J', nativeParamGetTaint (0));
#endif
	jint vbits;
...
{
#ifndef INTERPRETER
	nativeRetValSetTaint ('I', nativeParamGetTaint (0));
#endif
    jint vbits;
