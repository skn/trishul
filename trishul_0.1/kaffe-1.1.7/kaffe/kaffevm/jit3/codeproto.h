...
void pusharg_int(SlotInfo*, int, bool);
void pusharg_int_const(jint, int, bool);
void pusharg_ref(SlotInfo*, int, bool);
void pusharg_ref_const(void*, int, bool);
void pusharg_long(SlotInfo*, int, bool);
void pusharg_long_const(jlong, int, bool);
void pusharg_float(SlotInfo*, int, bool);
void pusharg_double(SlotInfo*, int, bool);
void pusharg_string_const(void*, int, bool);
void pusharg_class_const(struct Hjava_lang_Class*, int, bool);
void pusharg_utf8_const(Utf8Const*, int, bool);
...
void call(SlotInfo*, const Method *);
...
void do_taint_static_load ();
void taint_static_store (Field *field, SlotInfo *src);
void do_taint_static_store ();

void pushtaint_arg_marker ();
void do_pushtaint_arg_marker ();
...
void do_taint_object_load ();

void taint_object_store (SlotInfo *this, Field *field, SlotInfo *src);
void do_taint_object_store ();


/**
 * @param idx The SlotInfo containing the index expression, or NULL if the index is constant.
 */
void taint_array_load_before (SlotInfo* array, SlotInfo* idx, int idxConstant);
void taint_array_load_after  (SlotInfo* array, SlotInfo* dst);
void do_taint_array_load ();

void taint_array_store (SlotInfo* array, SlotInfo* idx, int offset, SlotInfo* src, char sig);
void do_taint_array_store ();

void do_rebuild_context_taint ();
...
void do_store_method_annotation ();

void do_store_nothrow_taint ();
