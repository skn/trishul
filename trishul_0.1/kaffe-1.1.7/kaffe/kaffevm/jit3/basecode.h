...
enum {
	...
	bule			= 12,	/* Unsigned less than or equal */

	branch_flag_notaint = 16,
};

#define branch_a(l)			branch(l, ba)

#define cbranch_int_eq_notaint(s1, s2, l)	cbranch_int(s1, s2, l, beq | branch_flag_notaint)
#define cbranch_int_eq(s1, s2, l, stackAdjust)	cbranch_int(s1, s2, l, beq)
#define cbranch_int_ne(s1, s2, l, stackAdjust)	cbranch_int(s1, s2, l, bne)
#define cbranch_int_lt(s1, s2, l, stackAdjust)	cbranch_int(s1, s2, l, blt)
#define cbranch_int_le(s1, s2, l, stackAdjust)	cbranch_int(s1, s2, l, ble)
#define cbranch_int_gt(s1, s2, l, stackAdjust)	cbranch_int(s1, s2, l, bgt)
#define cbranch_int_ge(s1, s2, l, stackAdjust)	cbranch_int(s1, s2, l, bge)
#define cbranch_int_ult(s1, s2, l, stackAdjust)	cbranch_int(s1, s2, l, bult)
#define cbranch_int_ugt(s1, s2, l, stackAdjust)	cbranch_int(s1, s2, l, bugt)
#define cbranch_int_uge(s1, s2, l, stackAdjust)	cbranch_int(s1, s2, l, buge)

#define cbranch_int_const_eq_notaint(s1, s2, l) cbranch_int_const(s1, s2, l, beq | branch_flag_notaint)
#define cbranch_int_const_eq(s1, s2, l, stackAdjust) cbranch_int_const(s1, s2, l, beq)
#define cbranch_int_const_ne_notaint(s1, s2, l) cbranch_int_const(s1, s2, l, bne | branch_flag_notaint)
#define cbranch_int_const_ne(s1, s2, l, stackAdjust) cbranch_int_const(s1, s2, l, bne)
#define cbranch_int_const_lt(s1, s2, l, stackAdjust) cbranch_int_const(s1, s2, l, blt)
#define cbranch_int_const_le(s1, s2, l, stackAdjust) cbranch_int_const(s1, s2, l, ble)
#define cbranch_int_const_gt(s1, s2, l, stackAdjust) cbranch_int_const(s1, s2, l, bgt)
#define cbranch_int_const_ge(s1, s2, l, stackAdjust) cbranch_int_const(s1, s2, l, bge)
#define cbranch_int_const_ult(s1, s2, l, stackAdjust) cbranch_int_const(s1, s2, l, bult)
#define cbranch_int_const_ugt(s1, s2, l, stackAdjust) cbranch_int_const(s1, s2, l, bugt)
...
#define cbranch_offset_int_ult_notaint(s1, s2, o, l)	cbranch_offset_int(s1, s2, o, l, bult | branch_flag_notaint)
...
#define cbranch_ref_eq(s1, s2, l, stackAdjust)	cbranch_ref(s1, s2, l, beq)
#define cbranch_ref_ne_notaint(s1, s2, l)	cbranch_int(s1, s2, l, bne | branch_flag_notaint)
#define cbranch_ref_ne(s1, s2, l, stackAdjust)	cbranch_ref(s1, s2, l, bne)

#define cbranch_ref_const_eq(s1, s2, l, stackAdjust)	cbranch_ref_const(s1, s2, l, beq)
#define cbranch_ref_const_ne_notaint(s1, s2, l)	cbranch_ref_const(s1, s2, l, bne | branch_flag_notaint)
#define cbranch_ref_const_ne(s1, s2, l, stackAdjust)	cbranch_ref_const(s1, s2, l, bne)
...
void slot_const_const_const(SlotInfo*, jword, jword, jword, ifunc, int);
void slot_slot_const(SlotInfo*, SlotInfo*, jword, ifunc, int);
void slot_slot_const_const(SlotInfo*, SlotInfo*, jword, jword, ifunc, int);
...
void lslot_lslot_const_const(SlotInfo*, SlotInfo*, jword, jword, ifunc, int);
