...
typedef uint8 Base64SHA1Digest[28]; /* Does not include asciiz 0 */
...
typedef struct _jarEntry {
	...
	SHA1Digest			sha1Class;
	Base64SHA1Digest	base64Sha1Entry;
...
typedef struct _jarFile {
	...
	Signature			*signatures; /* List of Signature */
	jarEntry			*manifest;
	Base64SHA1Digest	base64Sha1Manifest;
	Base64SHA1Digest	base64Sha1Attributes;
} jarFile;
...
typedef const uint8 *(*jarVerifyGetCertificate) (const char *name, SignatureType type, uint *certLength);
